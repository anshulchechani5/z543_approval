		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "543 Aprovel",
									"targetURL": "#z543approvel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"z543approvel-display": {
								"semanticObject": "z543approvel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=z543approvel",
									"url": sap.ui.require.toUrl("z543approvel")
								}
							}
						}
					}
